export default function NotFoundView({ navigate, language }) {
    return (
        <main className="flex-grow flex flex-col items-center justify-center pt-32 px-6 md:px-12 lg:px-24 pb-16 md:pb-32 max-w-4xl mx-auto w-full text-center">
            ...
            <a href={`/${language}`} onClick={(e) => navigate('/', e)} className="inline-flex justify-center items-center px-6 py-3 bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900 font-medium rounded-lg hover:opacity-90 transition-opacity shadow-sm gap-2">
